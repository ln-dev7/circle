...
import { useGymBookingsFilterStore, GymBookingsSortOption } from '@/store/gym-bookings-filter-store';
...
const sortOptions: { value: GymBookingsSortOption; label: string }[] = [
...
export function SortPopover({ children }: SortPopoverProps) {
  const { sortBy, setSortBy } = useGymBookingsFilterStore();
